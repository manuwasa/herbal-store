...
<div class="mt-6 bg-white rounded-2xl border border-stone-200 p-5">
    ...
    @if($order->tracking_number)
        <div class="mt-4 pt-4 border-t border-stone-200 text-sm">
            <p class="text-stone-500">Kurir: <span class="text-stone-800 font-medium">{{ $order->courier_name }}</span></p>
            <p class="text-stone-500">No. Resi: <span class="text-stone-800 font-mono">{{ $order->tracking_number }}</span></p>
        </div>
    @endif
